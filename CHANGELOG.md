...
## Release Highlights
- [FIX] Bulk-import (Kiro / CodeBuddy / Qoder) gak fail lagi dengan pesan "Playwright not available" di first-run — bundled Playwright sekarang langsung dipakai tanpa install ulang
- [FIX] Kalau install Playwright bener-bener gagal, error message sekarang nunjukin alasan jelas (network / permission / disk / NODE_PATH issue) bukan pesan generic
